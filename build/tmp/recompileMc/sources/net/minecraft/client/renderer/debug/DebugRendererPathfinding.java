...
public class DebugRendererPathfinding implements DebugRenderer.IDebugRenderer
{
    ...
    public void addPath(int p_188289_1_, Path pathIn, float distance)
    {
        this.pathMap.put(Integer.valueOf(p_188289_1_), pathIn);
        this.creationMap.put(Integer.valueOf(p_188289_1_), Long.valueOf(System.currentTimeMillis()));
        this.pathMaxDistance.put(Integer.valueOf(p_188289_1_), Float.valueOf(distance));
    }
